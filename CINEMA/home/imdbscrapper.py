...
def imdbsite(url):
	...
	return {'img':img, 'mlt':mltlist, 'lang':lang, 'runtime':runtime, 'genre':genre, 'plot':plot, 'rimdb':rating}
...
def comments(url):
	...
	return {'imdb1r':rating1, 'imdb1h':heading1, 'imdb1':review1, 'imdb2r':rating2, 'imdb2h':heading2, 'imdb2':review2}

def imdb(url):
	a=imdbsite(url)
	a.update(comments(url))
	return a
